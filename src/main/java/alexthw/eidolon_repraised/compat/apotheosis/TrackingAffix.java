...
public class TrackingAffix extends Affix implements StepScalingAffix {
    public static final Codec<TrackingAffix> CODEC = RecordCodecBuilder.create((inst) -> inst.group(affixDef(), LootRarity.mapCodec(StepFunction.CODEC).fieldOf("values").forGetter((a) -> a.values)).apply(inst, TrackingAffix::new));
    ...
    public TrackingAffix(AffixDefinition def, Map<LootRarity, StepFunction> values) {
        super(def);
        this.values = values;
    }
