...
public class EidolonAbstractTreeFeature extends Feature<TreeConfiguration> {
    ...
    private static final ResourceLocation ILLWOOD_TREE1 = ResourceLocation.parse("eidolon_repraised:illwood_tree1");
    private static final ResourceLocation ILLWOOD_TREE2 = ResourceLocation.parse("eidolon_repraised:illwood_tree2");
    private static final ResourceLocation ILLWOOD_TREE3 = ResourceLocation.parse("eidolon_repraised:illwood_tree3");
