...
public class NecromancerEntity extends SpellcasterIllager {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, (new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, (e) -> e.getServer() != null && e.getServer().overworld().getCapability(IReputation.INSTANCE).isPresent() && e.getServer().overworld().getCapability(IReputation.INSTANCE).resolve().get().getReputation((Player) e, Deities.DARK_DEITY.getId()) >= 50)).setUnseenMemoryTicks(300));
