...
public class FeatherParticle extends GenericParticle {
    public FeatherParticle(ClientLevel world, GenericParticleData data, double x, double y, double z, double vx, double vy, double vz) {
